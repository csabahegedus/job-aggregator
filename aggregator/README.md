...
| Freelancer.com | publikus `projects/active` API (query=iOS/React Native/mobile app) | valódi freelance-projekt marketplace (nem állásbörze); minden találat contract, budgettel; egy budget-floor már ingestionkor eldobja a ~$500 fix / ~$20/óra alatti gigeket (statikus árfolyamtáblával becsülve) |
